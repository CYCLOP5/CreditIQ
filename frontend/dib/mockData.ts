...
export const MOCK_USERS = [
  ...
  // { id: "usr_002", name: "Rahul Desai",    email: "rahul@boltautomotive.in",   role: "msme",           gstin: "07TQGWA2808D4Z3", status: "active",    created_at: "2024-06-01T09:00:00+05:30" },
  { id: "usr_003", name: "Imran Shaikh",   email: "imran@textilezone.in",      role: "msme",           gstin: "07QYJFY4493W9Z7", status: "active",    created_at: "2024-03-20T08:00:00+05:30" },
...
export const MOCK_SCORES: Record<string, any> = {
  ...
  task_abc002: {
    task_id: "task_abc002", gstin: "07TQGWA2808D4Z3", status: "complete",
  ...
  task_abc003: {
    task_id: "task_abc003", gstin: "07QYJFY4493W9Z7", status: "complete",
    ...
    msme_category: "micro", cgtmse_eligible: false, mudra_eligible: false,
    fraud_flag: true,
    fraud_details: { cycle_members: ["07QYJFY4493W9Z7", "29BCGFH1234S1ZP", "29XYZAB5678T1ZQ"], confidence: 0.91 },
    shap_waterfall: [
...
export const GSTIN_TASK_MAP: Record<string, string> = {
  ...
  "07TQGWA2808D4Z3": "task_abc002",
  "07QYJFY4493W9Z7": "task_abc003",
};
...
export const MOCK_PERMISSIONS = [
  ...
  { id: "perm_002", loan_request_id: "lr_002", gstin: "07TQGWA2808D4Z3", bank_id: "bank_002", bank_name: "Canara Bank",          status: "pending", requested_at: "2026-04-01T15:30:00+05:30", responded_at: null,                        expires_at: "2026-04-08T15:30:00+05:30" },
  { id: "perm_003", loan_request_id: "lr_004", gstin: "07TQGWA2808D4Z3", bank_id: "bank_001", bank_name: "State Bank of India", status: "granted", requested_at: "2026-02-16T10:00:00+05:30", responded_at: "2026-02-17T11:00:00+05:30", expires_at: "2026-03-17T11:00:00+05:30" },
];

// ---- DISPUTES ----
export const MOCK_DISPUTES = [
  { id: "disp_001", gstin: "07QYJFY4493W9Z7", msme_name: "TextileZone",       description: "Our GSTIN has been flagged as part of a fraud ring. The two other entities listed are suppliers we transact with regularly for fabric procurement. These are legitimate B2B transactions. We have GST invoices for all transfers.", status: "under_review", analyst_id: "usr_005", analyst_name: "Vikram Nair", resolution_note: null, created_at: "2026-04-02T08:00:00+05:30", updated_at: "2026-04-02T11:00:00+05:30" },
...
export const MOCK_GRAPH_TEXTILEZONE = {
  nodes: [
    { id: "07QYJFY4493W9Z7", label: "TextileZone",   flagged: true,  total_volume_inr: 4200000 },
  ...
  edges: [
    { source: "07QYJFY4493W9Z7", target: "29BCGFH1234S1ZP", tx_count: 24, total_amount_inr: 1800000 },
    { source: "29BCGFH1234S1ZP", target: "29XYZAB5678T1ZQ", tx_count: 22, total_amount_inr: 1650000 },
    { source: "29XYZAB5678T1ZQ", target: "07QYJFY4493W9Z7", tx_count: 23, total_amount_inr: 1740000 },
    { source: "07QYJFY4493W9Z7", target: "29AAACL9900M1ZT", tx_count: 4,  total_amount_inr: 160000  },
  ],
};
...
export const MOCK_GLOBAL_GRAPH = {
  nodes: [
    ...
    { id: "07TQGWA2808D4Z3", label: "BoltAutomotive", flagged: false, total_volume_inr: 2300000 },
  ...
  edges: [
    ...
    { source: "07TQGWA2808D4Z3", target: "19HLPRM4249Z3Z1", tx_count: 2,  total_amount_inr: 85000   },
  ],
};
...
export const MOCK_NOTIFICATIONS: Record<string, any[]> = {
  ...
  usr_005: [
    { id: "notif_011", type: "dispute_update",    title: "New dispute in queue",                  body: "GSTIN 07QYJFY4493W9Z7 has raised a fraud flag dispute.",                                 read: false, created_at: "2026-04-02T08:05:00+05:30", action_url: "/analyst/dispute-queue" },
  ],
  usr_006: [],
  usr_007: [],
};
...
export const MOCK_FRAUD_ALERTS = [
  { gstin: "07QYJFY4493W9Z7", msme_name: "TextileZone",   fraud_details: { cycle_members: ["07QYJFY4493W9Z7","29BCGFH1234S1ZP","29XYZAB5678T1ZQ"], confidence: 0.91 }, flagged_at: "2026-04-01T11:00:00+05:30", dispute_count: 1, dispute_status: "under_review" },
...
export const MOCK_AUDIT_LOG = [
  { id: "aud_001", user_id: "usr_005", user_name: "Vikram Nair",    role: "credit_analyst", action: "dispute_assigned",   target_type: "dispute",         target_id: "disp_001", metadata: { gstin: "07QYJFY4493W9Z7" },                                           timestamp: "2026-04-02T11:00:00+05:30" },
  { id: "aud_002", user_id: "usr_004", user_name: "Anjali Mehta",   role: "loan_officer",   action: "permission_requested",target_type: "permission",      target_id: "perm_002", metadata: { bank_id: "bank_001", gstin_masked: "07****08D4Z3" },                 timestamp: "2026-04-01T15:30:00+05:30" },
