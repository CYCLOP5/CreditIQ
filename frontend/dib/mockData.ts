...
export const MOCK_USERS = [
  ...
  // { id: "usr_002", name: "Rahul Desai",    email: "rahul@boltautomotive.in",   role: "msme",           gstin: "36ITDJE8781O1Z6", status: "active",    created_at: "2024-06-01T09:00:00+05:30" },
...
export const MOCK_SCORES: Record<string, any> = {
  ...
  task_abc002: {
    task_id: "task_abc002", gstin: "36ITDJE8781O1Z6", status: "complete",
...
export const MOCK_PERMISSIONS = [
  ...
  { id: "perm_002", loan_request_id: "lr_002", gstin: "36ITDJE8781O1Z6", bank_id: "bank_002", bank_name: "Canara Bank",          status: "pending", requested_at: "2026-04-01T15:30:00+05:30", responded_at: null,                        expires_at: "2026-04-08T15:30:00+05:30" },
  { id: "perm_003", loan_request_id: "lr_004", gstin: "36ITDJE8781O1Z6", bank_id: "bank_001", bank_name: "State Bank of India", status: "granted", requested_at: "2026-02-16T10:00:00+05:30", responded_at: "2026-02-17T11:00:00+05:30", expires_at: "2026-03-17T11:00:00+05:30" },
];
...
export const MOCK_GLOBAL_GRAPH = {
  nodes: [
    ...
    { id: "36ITDJE8781O1Z6", label: "BoltAutomotive", flagged: false, total_volume_inr: 2300000 },
  ...
  edges: [
    ...
    { source: "36ITDJE8781O1Z6", target: "19HLPRM4249Z3Z1", tx_count: 2,  total_amount_inr: 85000   },
  ],
};
...
export const MOCK_AUDIT_LOG = [
  ...
  { id: "aud_002", user_id: "usr_004", user_name: "Anjali Mehta",   role: "loan_officer",   action: "permission_requested",target_type: "permission",      target_id: "perm_002", metadata: { bank_id: "bank_001", gstin_masked: "36****81O1Z6" },                 timestamp: "2026-04-01T15:30:00+05:30" },
