...
export const MOCK_USERS = [
  // { id: "usr_001", name: "Priya Sharma",   email: "priya@bakerycraft.in",      role: "msme",           gstin: "29MUSKV7503C9Z0", status: "active",    created_at: "2024-08-15T10:00:00+05:30" },
  // { id: "usr_002", name: "Rahul Desai",    email: "rahul@boltautomotive.in",   role: "msme",           gstin: "36CWGXT1223V5Z8", status: "active",    created_at: "2024-06-01T09:00:00+05:30" },
  { id: "usr_003", name: "Imran Shaikh",   email: "imran@textilezone.in",      role: "msme",           gstin: "19DUTDZ1506O6Z3", status: "active",    created_at: "2024-03-20T08:00:00+05:30" },
...
export const MOCK_SCORES: Record<string, any> = {
  task_abc001: {
    task_id: "task_abc001", gstin: "29MUSKV7503C9Z0", status: "complete",
  ...
  task_abc002: {
    task_id: "task_abc002", gstin: "36CWGXT1223V5Z8", status: "complete",
  ...
  task_abc003: {
    task_id: "task_abc003", gstin: "19DUTDZ1506O6Z3", status: "complete",
    ...
    msme_category: "micro", cgtmse_eligible: false, mudra_eligible: false,
    fraud_flag: true,
    fraud_details: { cycle_members: ["19DUTDZ1506O6Z3", "29BCGFH1234S1ZP", "29XYZAB5678T1ZQ"], confidence: 0.91 },
    shap_waterfall: [
...
export const GSTIN_TASK_MAP: Record<string, string> = {
  "29MUSKV7503C9Z0": "task_abc001",
  "36CWGXT1223V5Z8": "task_abc002",
  "19DUTDZ1506O6Z3": "task_abc003",
};
...
export const MOCK_GRAPH_TEXTILEZONE = {
  nodes: [
    { id: "19DUTDZ1506O6Z3", label: "TextileZone",   flagged: true,  total_volume_inr: 4200000 },
  ...
  edges: [
    { source: "19DUTDZ1506O6Z3", target: "29BCGFH1234S1ZP", tx_count: 24, total_amount_inr: 1800000 },
    { source: "29BCGFH1234S1ZP", target: "29XYZAB5678T1ZQ", tx_count: 22, total_amount_inr: 1650000 },
    { source: "29XYZAB5678T1ZQ", target: "19DUTDZ1506O6Z3", tx_count: 23, total_amount_inr: 1740000 },
    { source: "19DUTDZ1506O6Z3", target: "29AAACL9900M1ZT", tx_count: 4,  total_amount_inr: 160000  },
  ],
};
...
export const MOCK_GLOBAL_GRAPH = {
  nodes: [
    ...
    { id: "29XYZAB5678T1ZQ", label: "ThreadMasters",  flagged: true,  total_volume_inr: 3600000 },
    { id: "29AAACL9900M1ZT", label: "Loomex Pvt Ltd", flagged: false, total_volume_inr: 520000  },
    { id: "29MUSKV7503C9Z0", label: "BakeryCraft",    flagged: false, total_volume_inr: 8100000 },
    { id: "36CWGXT1223V5Z8", label: "BoltAutomotive", flagged: false, total_volume_inr: 2300000 },
  ...
  edges: [
    ...
    { source: "29MUSKV7503C9Z0", target: "29AAACL9900M1ZT", tx_count: 6,  total_amount_inr: 240000  },
    { source: "36CWGXT1223V5Z8", target: "29MUSKV7503C9Z0", tx_count: 2,  total_amount_inr: 85000   },
  ],
};
...
export const MOCK_NOTIFICATIONS: Record<string, any[]> = {
  ...
  usr_005: [
    { id: "notif_011", type: "dispute_update",    title: "New dispute in queue",                  body: "GSTIN 19DUTDZ1506O6Z3 has raised a fraud flag dispute.",                                 read: false, created_at: "2026-04-02T08:05:00+05:30", action_url: "/analyst/dispute-queue" },
  ],
  usr_006: [],
  usr_007: [],
};
...
export const MOCK_FRAUD_ALERTS = [
  { gstin: "19DUTDZ1506O6Z3", msme_name: "TextileZone",   fraud_details: { cycle_members: ["19DUTDZ1506O6Z3","29BCGFH1234S1ZP","29XYZAB5678T1ZQ"], confidence: 0.91 }, flagged_at: "2026-04-01T11:00:00+05:30", dispute_count: 1, dispute_status: "under_review" },
...
export const MOCK_AUDIT_LOG = [
  { id: "aud_001", user_id: "usr_005", user_name: "Vikram Nair",    role: "credit_analyst", action: "dispute_assigned",   target_type: "dispute",         target_id: "disp_001", metadata: { gstin: "19DUTDZ1506O6Z3" },                                           timestamp: "2026-04-02T11:00:00+05:30" },
